---
lab:
  title: 'النشاط العملي: نشر قوالب Azure Resource Manager'
  module: 'Module 1: Exploring Azure Resource Manager'
---

# النشاط العملي: نشر قوالب Azure Resource Manager
# دليل النشاط العملي للطالب

## سيناريو النشاط المعملي

Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus lobortis, erat vel egestas faucibus, dui magna semper velit, id congue sapien lectus id turpis. Nam egestas tempus enim. Ut venenatis vehicula ex, id rutrum odio lacinia في. Donec congue, tortor sed fermentum imperdiet, mauris mi auctor dui, ac cursus ex augue a odio. Aliquam erat volutpat. Vivamus faucibus fringilla augue في dignissim. Quisque sit amet nulla id risus gravida auctor. Ut in est varius, cursus odio rhoncus, placerat erat. Suspendisse nec metus est.

## الأهداف

بعد إكمال هذا النشاط العملي، ستكون قادرًا على:
